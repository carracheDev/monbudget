...
class _BudgetScreenState extends ConsumerState<BudgetScreen> {
  ...
  final depense = transactions
      .where((t) =>
          t.categorieId == budget.categorieId &&
          t.type.name == 'DEPENSE')
      .fold(0.0, (sum, t) => sum + t.montant);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      onPressed: () =>
                          _showCreerCategorie(setModalState),
                ...
                Wrap(
                  ...
                  children: categories.map((cat) {
                    ...
                    return GestureDetector(
                      onTap: () =>
                          setModalState(() => categorieId = cat.id),
